<script>
     ...
     $("[name=form_data]").on('submit', function(e) {
          ...
          if(save_method == 'add'){
               var url = '{{route("master.prodi.simpan")}}';
          }else{
               var url = '{{route("master.prodi.ubah")}}';
          }
     ...
     $("[name=form_excel]").on('submit', function(e) {
          ...
          var data = new FormData(form);
          var url = '{{route("master.prodi.upload")}}';
