               ...
               @csrf
                    <div class="modal-body">
                         <div class="form-group row mb-4">
                              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">NIDN<span class="text-danger">*</span></label>
                         ...
                         <div class="form-group row mb-4">
                              ...
                              <div class="col-sm-12 col-md-9">
                                  <textarea name="keterangan" class="form-control" style="height:100px;resize:none"></textarea>
                                   <div class="invalid-feedback">
                                   </div>
                              </div>
                         </div>
