<script>
     ...
     $("[name=form_data]").on('submit', function(e) {
          ...
          if(save_method == 'add'){
               var url = '{{route("master.semester.simpan")}}';
          }else{
               var url = '{{route("master.semester.ubah")}}';
          }
     ...
     function ubah(id)
     {
          ...
          $.ajax({
               url : "{{url('master/semester/data/')}}"+"/"+id,
               type: "GET",
               dataType: "JSON",
     ...
     function hapus(id)
     {
          Swal.fire({
               ...
               if (result.value) {
                    $.ajax({
                         url : "{{url('master/semester/hapus/')}}"+"/"+id,
                         type: "POST",
                         data : {
                              '_method'   : 'delete',
                              '_token'    : '{{ csrf_token() }}',
