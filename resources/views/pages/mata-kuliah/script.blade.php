<script>
     ...
     $("[name=form_data]").on('submit', function(e) {
          ...
          if(save_method == 'add'){
               var url = '{{route("master.mata-kuliah.simpan")}}';
          }else{
               var url = '{{route("master.mata-kuliah.ubah")}}';
          }
     ...
     function ubah(id)
     {
          ...
          $.ajax({
               url : "{{url('master/mata-kuliah/data/')}}"+"/"+id,
               type: "GET",
               dataType: "JSON",
     ...
     function hapus(id)
     {
          Swal.fire({
               ...
               if (result.value) {
                    $.ajax({
                         url : "{{url('master/mata-kuliah/hapus/')}}"+"/"+id,
                         type: "POST",
                         data : {
                              '_method'   : 'delete',
                              '_token'    : '{{ csrf_token() }}',
     ...
     $("[name=form_excel]").on('submit', function(e) {
          ...
          var data = new FormData(form);
          var url = '{{route("master.mata-kuliah.upload")}}';
