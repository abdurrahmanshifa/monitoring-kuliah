...
@section('title')
     <title>
          Master Mata Kuliah - Sistem Monitoring Perkuliahan
     </title>
@endsection
                    ...
                    <div class="card">
                         <div class="card-header">
                              ...
                              <div class="card-header-form">
                                   <a class="btn btn-icon btn-warning" href="{{ url('public/excel/upload-mata-kuliah.xlsx') }}" title="Download Template Excel">
...
@section('modal')
     @include('pages.mata-kuliah.modal')     
@endsection

@section('script')
     @include('pages.mata-kuliah.script')
@endsection