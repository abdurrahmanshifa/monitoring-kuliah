...
@section('title')
     <title>
          Penilaian Dosen - Sistem Monitoring Perkuliahan
     </title>
@endsection
...
<section class="section">
     <div class="section-header">
          ...
          <div class="section-header-breadcrumb">
               ...
               <div class="breadcrumb-item">Penilaian Dosen</div>
          </div>
     </div>
                         ...
                         <div class="collapse show" id="mycard-collapse" style="">
                              <div class="card-body p-0">
                                   <div style="padding: 30px;">
                                        <form action="{{ route('laporan.penilaian.cetak') }}" role="form" id="form_data" name="form_data" method="post">
                                        @csrf
                                             <div class="modal-body">
                                                  <div class="form-group row mb-4">
                                                       <label class="col-form-label col-12 col-md-3 col-lg-3">Dosen</label>
                                                       <div class="col-sm-12 col-md-9">
                                                            <select name="dosen_id" class="form-control select2" required>
                                                                 <option value="0">Pilih Semua Dosen</option>
