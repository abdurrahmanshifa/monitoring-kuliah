               ...
               @csrf
                    <div class="modal-body">
                         <div class="form-group row mb-4">
                              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">NIM<span class="text-danger">*</span></label>
                         ...
                         <div class="form-group row mb-4">
                              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Ketua Tingkat</label>
                              <div class="col-sm-12 col-md-9">
                                   <select name="status_ketua" class="form-control select2">
                                   ...
                                   <span>
                                        Jika ketua tingkat dipilih 'ya' maka user bisa melakukan input disistem dengan email dan password yang sama dengan email yang dinput.
                                   </span>
                              </div>
                         </div>
                         <div class="form-group row mb-4">
