<script>
     ...
     $("[name=form_data]").on('submit', function(e) {
          ...
          if(save_method == 'add'){
               var url = '{{route("master.ruang.simpan")}}';
          }else{
               var url = '{{route("master.ruang.ubah")}}';
          }
     ...
     $("[name=form_excel]").on('submit', function(e) {
          ...
          var data = new FormData(form);
          var url = '{{route("master.ruang.upload")}}';
