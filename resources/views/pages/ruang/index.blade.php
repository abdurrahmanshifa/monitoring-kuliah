...
@section('title')
     <title>
          Master Ruang - Sistem Monitoring Perkuliahan
     </title>
@endsection
...
<section class="section">
     <div class="section-header">
          ...
          <div class="section-header-breadcrumb">
               ...
               <div class="breadcrumb-item">Ruang</div>
          </div>
     </div>
                    ...
                    <div class="card">
                         <div class="card-header">
                              ...
                              <div class="card-header-form">
                                   <a class="btn btn-icon btn-warning" href="{{ url('public/excel/upload-ruang.xlsx') }}" title="Download Template Excel">
...
@section('modal')
     @include('pages.ruang.modal')     
@endsection

@section('script')
     @include('pages.ruang.script')
@endsection